...
// Сейчас это только dev-витрины /demo и /demo-master: они живут на
// подставных данных, базу не трогают, а в прод-сборке сами уводят на вход.
const PUBLIC_SEGMENTS = new Set(['demo', 'demo-master']);
