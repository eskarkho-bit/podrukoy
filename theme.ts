...
const light = {
  ...
  // Вторичные цвета держат контраст не ниже 4.5:1 на card и bg: мелкие даты
  // и подсказки — тоже содержимое, их читают, а не угадывают
  textSoft: '#5A6554', // вторичный текст
  textMuted: '#667261', // подписи, плейсхолдеры
...
const dark: Palette = {
  ...
  text: '#E6ECE1',
  textSoft: '#A3AF9C',
  // Как и в светлой теме, не ниже 4.5:1 на карточке
  textMuted: '#9AA792',
  accent: '#8FAF83',
  accentStrong: '#B4CCA8',
  accentSoft: '#2B3827',
