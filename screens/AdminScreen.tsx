  ...
  return (
    <Animated.View entering={FadeInDown.delay(60).duration(360)} style={styles.stats}>
      ...
      {stats.prices ? (
        ...
        // Ноль рублей выглядел бы как настоящее число — честнее сказать,
        // что считать пока нечем.
        <Text style={styles.statsHint}>Появится, когда завершится первый заказ</Text>
      )}
    </Animated.View>
  );
}
