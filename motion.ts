...
export const springs = {
  ...
  // вместо расписанной последовательности «вверх, потом сесть». Гашение
  // подняли с 0.5 до 0.72: при 0.5 карточка подскакивала заметно и вместе с
  // выезжающим следом экраном читалась как рывок, особенно на слабых
  // устройствах; при 0.72 перелёт остаётся, но едва заметный
  pop: { duration: 260, dampingRatio: 0.72 },
